...
import { Coffee01Icon, Mail01Icon, SquareLock01Icon } from "@hugeicons/core-free-icons";
...
type SignInSearchParams = Promise<{ error?: string; next?: string }>;
...
export default function SignInPage({
  ...
  return (
    <Suspense fallback={<AuthFormSkeleton />}>
      <SignInForm searchParams={searchParams ?? Promise.resolve({})} />
    </Suspense>
  );
}

async function SignInForm({ searchParams }: { searchParams: SignInSearchParams }) {
